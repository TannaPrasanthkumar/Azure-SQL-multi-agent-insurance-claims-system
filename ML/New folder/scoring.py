...
def init():
    ...
    try:
        ...
        if model_dir:
            ...
            metadata_file = base_path / "New folder/model_metadata_0.pkl"
            encoder_file = base_path / "New folder/label_encoders_0.pkl"
            scaler_file = base_path / "New folder/scaler_0.pkl"
            model_file = base_path / "New folder/balanced_random_forest_fraud_detector_0.pkl"
